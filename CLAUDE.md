...
| **Supervisor Checks** | Partial | Entry screen now has Crane Meeting card + Coming Soon for pre-lift checklists |
...
### 12.4 Thorough Examination & Status Logic
...
### 12.8 Public MEWP Page (QR/NFC Scan — no login required)
...
### 12.9 Screen Structure (inside lifting-app)
...
### 12.10 Supabase Tables (MEWP module)
...
### 12.12 Supabase Storage Buckets
...
### 12.13 Authentication (MEWP module)
...
### 12.17 Critical Workarounds (do not skip)
...
### 12.18 RLS Policy Summary (MEWP tables)
