...
export default function OperativeOperatorChecks() {
  return (
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <Text style={styles.title}>Operator Checks</Text>
        <Text style={styles.desc}>
          Daily pre-use inspection checklist for crane operators.{'\n'}
          Covers crane condition, controls, safety devices, and environmental checks.
        </Text>
...
const styles = StyleSheet.create({
  ...
  iconWrap: { width: 80, height: 80, borderRadius: 20, backgroundColor: '#BE185D20', alignItems: 'center', justifyContent: 'center', marginBottom: Spacing.lg },
  icon: { fontSize: 40 },
