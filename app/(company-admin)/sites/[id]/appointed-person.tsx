...
export default function AppointedPersonForm() {
  const { id, apId } = useLocalSearchParams<{ id: string; apId?: string }>()
  const router = useRouter()
  const isEdit = Boolean(apId)
          ...
          >
            {isSubmitting ? (
              ...
              <Text style={formStyles.submitBtnText}>
                {isEdit ? 'Save Changes' : 'Add Appointed Person'}
              </Text>
            )}
          </TouchableOpacity>
        </ScrollView>
